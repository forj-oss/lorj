...
class YamlStudentsController
  ...
  def get_attr(oControlerObject, key)
    ...
    fail "get_attr: attribute '%s' is unknown in '%s'. Valid one are : '%s'" % [key[0], oControlerObject.class, @@valid_attributes] unless @@valid_attributes.include?(key[0])
  ...
  def set_attr(oControlerObject, key, value)
    attributes = oControlerObject
    fail "set_attr: attribute '%s' is unknown in '%s'. Valid one are : '%s'" % [key[0], oControlerObject.class, @@valid_attributes] unless @@valid_attributes.include?(key[0])
